...
def construct_index(index_dir, model_name, h_dim=768, HNSW=False, M=m):
...
class Retriever: 
    ...
    def get_relevant_documents(self, question, k=K, id_only=False, **kwarg):
...
class RetrievalSystem:
    ...
    def retrieve(self, question, k=K, rrf_k=100, id_only=False):
        '''
    ...
    def merge(self, texts, scores, k=K, rrf_k=100):
        '''
